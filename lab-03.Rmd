---
title: "Lab 03 - Take a sad plot and make it bette"
author: "Lilian, Cathy, User3, User4, User5 and User6 - Team Name"
...
_The width of each bar is different so the graph has a misleading visualisation about the relative numbers of the language speakers._
...
_A lack of key so the reader will not understands the use of the pie chart, and the meaning of the size and the colour of each piece of pie._
...
_Too complicated visualisation!! The labels are also blur so the information there is vague._
...
_Non-standard y-axis so the representation of total income for each country is confusing to the reader. It is hard to see the relative amount of income between countries._
